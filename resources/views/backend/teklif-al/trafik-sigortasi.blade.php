...
@section('title', 'Trafik Sigortası Teklifi Oluştur')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">Trafik Sigortası Teklifi Oluştur</h4>
                        <p class="text-muted mb-0">Trafik sigortası teklifi için gerekli bilgileri girin</p>
                    </div>
                </div>
                <div class="card-body">
                    @if($customer)
                    ...
                    <form action="{{ route('admin.teklif-al.trafik-sigortasi.store') }}" method="POST">
                        @csrf

...
@section('title', 'Yeni Müşteri Ekle - Nice Yazılım')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tc_no') is-invalid @enderror" id="tc_no" name="tc_no" value="{{ old('tc_no') }}" maxlength="11" pattern="[0-9]{11}">
                                        @error('tc_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>

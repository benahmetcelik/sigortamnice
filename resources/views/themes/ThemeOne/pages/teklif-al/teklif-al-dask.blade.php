                        ...
                        <div class="bg-light p-2">
                            ...
                            <div class="col-12">
                                ...
                                <div class="summary">
                                    ...
                                    <div
                                        class="health-institution__selectForm health-institution__selectForm--fastSupport">
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div
                                                    class="row d-flex justify-content-center health-institution-container">
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="uavt_city"> İl</label>
                                                        <select id="uavt_city" required="" type="text" name="uavt_city"
                                                                title="İl seçiniz"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData( this.value, 'ilce')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="district">İlçe</label>
                                                        <select id="ilce" required="" type="text" name="ilce"
                                                                title="İlçe seçiniz"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData( this.value, 'bucak')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="bucak">Bucak/Köy2</label>
                                                        <select id="bucak" required="" type="text" name="bucak"
                                                                title="Bucak/Köy seçiniz"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData(this.value, 'mahalle')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="mahalle">Mahalle</label>
                                                        <select id="mahalle" required="" type="text" name="mahalle"
                                                                title="Mahalle seçiniz" data-dropup-auto="false"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData( this.value, 'sokak')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="sokak">Sokak</label>
                                                        <select id="sokak" required="" type="text" name="sokak"
                                                                title="Sokak seçiniz" data-dropup-auto="false"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData( this.value, 'bina')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="bina">Kapı Numarası</label>
                                                        <select id="bina" required="" type="text" name="bina"
                                                                title="Kapı Numarası seçiniz" data-dropup-auto="false"
                                                                class=" form-control form-control-lg dropdown"
                                                                onchange="getData( this.value, 'daire')"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <label for="daire">Daire Numarası</label>
                                                        <select id="daire" required="" type="text" name="daire"
                                                                title="Daire Numarası seçiniz" data-dropup-auto="false"
                                                                class=" form-control form-control-lg dropdown"></select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 health-check">
                                                        <button type="button" style="width: 200px" onclick="hesapla()"
                                                                class="btn turquoise-btn send-btn m-t-15">SORGULA
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div
                                                class="col-12 col-md-6 col-lg-6 d-flex justify-content-center align-items-center">
                                                <div class="row health-check">
                                                    <div class="col-12 text-center mt-5">
                                                        <h2 class="blue-color text-center">Adres Kodu (UAVT)</h2>
                                                    </div>
                                                    <div class="col-12 text-center">
                                                        <h3 class="turquoise-color m-0 p-0 pt-3"><b id="uavtKodu"></b>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
